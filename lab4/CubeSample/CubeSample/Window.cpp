...
{
	// включаем освещение источник света №0
	...
	// Включаем тест глубины для удаления невидимых линий и поверхностей, и запись в буфер глубины
	glEnable(GL_DEPTH_TEST);
	glDepthMask(GL_TRUE);

	//Режим смешивания цветов
	glEnable(GL_BLEND);
	//для вывода полупрозрачных объектов
